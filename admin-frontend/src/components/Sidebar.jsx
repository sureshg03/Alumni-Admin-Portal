...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        style={{
          background: 'linear-gradient(to bottom, #1f003d, #3f0075)'
        }}
        className={`fixed inset-y-0 left-0 w-64 text-white p-4 flex flex-col shadow-2xl transform transition-transform duration-300 ease-in-out z-40
