        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4 relative z-10 pt-12 md:pt-0">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center text-white px-4 py-2 sm:px-6 sm:py-3 rounded-full hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-xl hover:ring-2 hover:ring-green-400 w-full sm:w-auto"
              disabled={isLoading}
